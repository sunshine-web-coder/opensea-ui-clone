...
import Logo from "../../assets/opensea-pride.svg";
import "./header.css";
import LogoSvg from "./LogoSvg";
import { useState } from "react";
import exploreData from "../../allData/explore.json";
import resourcesLinks from "../../allData/resourcesLinks.json"
...
const Header = ({ toggleTheme }) => {
  ...
  const [openWalletConn, setOpenWalletConn] = useState(false);
    ...
    <div className="header">
      <div className="in-header">
        ...
        <div className="sC">
          ...
          <SearchOutlinedIcon
            className="searchIcon MsearchIcon"
            onClick={() => setShowSearch(!showSearch)}
          />
          <div className={`inSc ${showSearch ? "open" : ""}`}>
            <div className="searchContainer">
              ...
              <input
                type="text"
                className="searchInput MsearchInput"
                placeholder="Search OpenSea"
              />
            </div>
          </div>
        </div>
        <div className={`navOverlay ${menuActive ? "open" : ""}`}></div>
          ...
          <ul>
            ...
            >
              ...
              <div className="navDropDown">
                <ul className="inNavDropDown">
                  {exploreData.map((exploreDatas) => {
                    return(
                      <li>
                        <Link onClick={() => setIsShown1(false)} to={exploreDatas.explorePath}>
                          <img src={exploreDatas.img} alt="" /> 
                          {exploreDatas.title}
                        </Link>
                      </li>
                    )
            ...
            <li onMouseEnter={() => setIsShown2(true)}
                onMouseLeave={() => setIsShown2(false)}>
                <Link to="/rankings">Stats</Link>
                {isShown2 && (
                <div className="navDropDown">
                  <ul className="inNavDropDown">
                    <li>
                      <Link onClick={() => setIsShown2(false)} to="/rankings">Rankings</Link>
                    </li>
                    <li>
                      <Link onClick={() => setIsShown2(false)} to="/activity">Activity</Link>
                    </li>
                  </ul>
                </div>
                )}
            </li>
            <li onMouseEnter={() => setIsShown3(true)}
              ...
              <div className="navDropDown">
                <ul className="inNavDropDown">
                  {resourcesLinks.map((resourcesLink) => {
                    return(
                      <li>
                        <Link onClick={() => setIsShown1(false)} to={resourcesLink.resourcesPath}>
                          {resourcesLink.title}
                        </Link>
                      </li>
                    )
                  })}
                  <li className="inNavResourcesFooter">
                    <svg
                      class="Icon--withHoverChange"
                      fill="#8A939B"
                      viewBox="0 0 18 16"
        ...
        <div className="profile_connect">
          ...
          >
            <Link to="/account">
              <AccountCircleOutlinedIcon className="header_icon userIcon" />
            </Link>
            {isShown && (
              <div className="profileSettingContainer">
                <div className="profileSetting">
                  <ul>
                    <li>
                      <Link onClick={() => setIsShown(false)} to="/account">
                        <PersonIcon /> Profile
                      </Link>
                    </li>
                    <li>
                      <Link onClick={() => setIsShown(false)} to="">
                    ...
                    <li>
                      <Link onClick={() => setIsShown(false)} to="/collections">
                    ...
                    <li className="D_darkmodeSwith">
                      <div>
                        <BedtimeIcon className="moonIcon" />
                        Night mode
                      </div>
                      {/* <button onClick={() => toggleTheme(!true)}>click</button> */}
          ...
          <AccountBalanceWalletOutlinedIcon
            ...
            onClick={() => setOpenWalletConn(!openWalletConn)}
          />
          <div
            className={`connectWalletListsDrawerOverlay ${
              openWalletConn ? "open" : ""
            }`}
          >
            <div
              className={`connectWalletListsDrawer ${
                openWalletConn ? "open" : ""
              }`}
            >
              <div className="cWLDheader">
                <AccountCircleIcon className="cWLDHi" />
                <span>My wallet</span>
              </div>
              <div className="cWLDb">
                ...
                <div className="cWLDhWLists">
                  <button className="fCWb">
                    <div>
                      <img src="https://i.im.ge/2022/07/09/updEYG.png" alt="" />
                      <span>MetaMask</span>
                    </div>
                  ...
                  <button>
                    <div>
                      <img src="https://i.im.ge/2022/07/09/upq77x.png" alt="" />
                      <span>Coinbase Wallet</span>
                    </div>
                  </button>
                  <button>
                    <div>
                      <img src="https://i.im.ge/2022/07/09/upqDCa.png" alt="" />
                      <span>WalletConnect</span>
                    </div>
                  </button>
                  <button>
                    <div>
                      <img src="https://i.im.ge/2022/07/09/upqIpJ.png" alt="" />
                      <span>Phantom</span>
                    </div>
                  ...
                  <button>
                    <div>
                      <img src="https://i.im.ge/2022/07/09/upqU2y.png" alt="" />
                      <span>Glow</span>
                    </div>
                    <div className="cWLDhWNpo cWLDhWNnpo">Solana</div>
                  </button>
                  {showMoreWa && (
                    <>
                      <button>
                        <div>
                          <img
                            src="https://i.im.ge/2022/07/09/up76DL.png"
                            alt=""
                          />
                          <span>Fortmatic</span>
                        </div>
                      ...
                      <button>
                        <div>
                          <img
                            src="https://i.im.ge/2022/07/09/up7A6J.png"
                            alt=""
                          />
                          <span>Kaikas</span>
                        </div>
                      ...
                      <button>
                        <div>
                          <img
                            src="https://i.im.ge/2022/07/09/up7NCG.png"
                            alt=""
                          />
                          <span>Bitski</span>
                        </div>
                      ...
                      <button>
                        <div>
                          <img
                            src="https://i.im.ge/2022/07/09/up7ySa.png"
                            alt=""
                          />
                          <span>Venly</span>
                        </div>
                      ...
                      <button>
                        <div>
                          <img
                            src="https://i.im.ge/2022/07/09/up7Pvx.png"
                            alt=""
                          />
                          <span>Dapper</span>
                        </div>
                      ...
                      <button>
                        <div>
                          <img
                            src="https://i.im.ge/2022/07/09/up7CVy.png"
                            alt=""
                          />
                          <span>Authereum</span>
                        </div>
                      ...
                      <button>
                        <div>
                          <img
                            src="https://i.im.ge/2022/07/09/up7xrS.png"
                            alt=""
                          />
                          <span>Torus</span>
                        </div>
                      ...
                      <button>
                        <div>
                          <img
                            src="https://i.im.ge/2022/07/09/up7Yg6.png"
                            alt=""
                          />
                          <span>Portis</span>
                        </div>
                      ...
                      <button className="disabledButton">
                        <div>
                          <img
                            src="https://i.im.ge/2022/07/09/up7cMF.png"
                            alt=""
                          />
                      ...
                      <button className="disabledButton">
                        <div>
                          <img
                            src="https://i.im.ge/2022/07/09/up7gDK.png"
                            alt=""
                          />
                          <span>Trust</span>
                        </div>
                  ...
                  {showMoreWa ? (
                    <button
                      className="showMoreWa"
                      onClick={() => setShowMoreWa(!showMoreWa)}
                    >
                      Show fewer options
                    </button>
                  ) : (
        ...
        <div className="hamburger" onClick={() => setMenuState(!menuActive)}>
          {menuActive ? (
            <CloseIcon className="hamburgerIcon" />
          ) : (
            <MenuOutlinedIcon className="hamburgerIcon" />
          )}
        </div>
        {menuActive && <MobileHeader />}
      </div>
    </div>
  );
};
